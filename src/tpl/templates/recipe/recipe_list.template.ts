  ...
  html`
    ...
    <div class="dropdown-menu p-2 dropdown-menu-lg-end" id="tag-filter">
      <div class="input-group mb-2">
        ...
        <input type="search" class="form-control input-filter" autocomplete="off" title="${e(t("navigation.filter_title"))}"
  ...
  return html`
    <form class="col" id="orderBy">
      <div class="input-group">
        ...
        <select class="form-select" title="${e(t("recipe.order_by"))}" autocomplete="off" name="orderBy">
...
export const RecipeListTemplate = (
  ...
  <div class="row g-3 mb-3">
    <form class="d-flex col-lg-9" method="get" action="${UrlGenerator.recipeList()}">
      <div class="input-group">
        <input class="form-control" type="search" name="title" placeholder="${e(t("search"))}" title="${e(t("search"))}"
  ...
  ${currentUrl.searchParams.get("flash") === "deleteSuccessful" && Alert("success", t("info"), t("recipe.delete_successful"))}
  ${recipes.totalItems
    ? html`
            ...
            <div class="recipe h-100">
              ...
              <a class="card card-linked h-100" href="${UrlGenerator.recipe(recipe)}">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    <small class="text-muted">
                      ${
                        recipe.lastCookedAt
                          ? e(t("recipe.last_cooked", { distance: date.formatDistanceToNow(recipe.lastCookedAt) }))
                ...
                <div class="card-footer text-muted d-flex justify-content-between">
                  ...
                  <span class="d-flex align-items-center" title="${e(t("recipe.time.total"))}">
