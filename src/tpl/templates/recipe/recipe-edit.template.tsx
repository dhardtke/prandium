        ...
        <div class="card-body">
          <div class="grid" style="grid-template-columns: 1fr 1fr 1fr;">
            <div class="col-sm">
              ...
              <input type="number" min="0" step=".01" id="aggregateRatingValue" name="aggregateRatingValue" value={props.recipe?.aggregateRatingValue ?? ""} />
            </div>
            ...
            <div class="col-sm">
              ...
              <input type="number" min="0" id="aggregateRatingCount" name="aggregateRatingCount" value={props.recipe?.aggregateRatingCount ?? ""} />
            </div>
            <div class="col-sm">
              <label for="rating">
                {l.recipe.rating}
