          ...
          <div class="side-by-side">
            ...
            <form id="ingredients-form" action="#ingredients">
              <div class="input-group input-group-sm w-auto">
                <input type="number" class="form-control portions" name="portions" value={props.portions} min="1" max="99" title={l.recipe.portions} />
...
export const RecipeDetailTemplate = (props: { recipe: Recipe; portions?: number }) => (
  <Page title={props.recipe.title}>
    ...
    {Page.currentUrl.searchParams.get("flash") === "editSuccessful"
      ...
      : Page.currentUrl.searchParams.get("flash") === "createSuccessful" && <Alert type="success" title={l.info}>{l.recipe.createSuccessful}</Alert>}
