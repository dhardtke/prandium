...
Deno.test("tpl", async (t) => {
  ...
  await t.step("e", async (t) => {
    await t.step(`e returns an empty string when input is undefined`, () => {
      assertEquals(e(undefined), "");
    });

    await t.step("escapes special HTML characters", () => {
      const actual = e(
   ...
   dolore magna aliquyam erat, &lt;sed&gt; diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum.
    ...
    await t.step("does not change allowed UTF-8 characters", () => {
