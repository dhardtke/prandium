...
import * as Reflect from "https://esm.sh/@abraham/reflection@0.10.0?pin=v66&no-check";
...
export * as fs from "https://deno.land/std@0.132.0/fs/mod.ts";
export * as Colors from "https://deno.land/std@0.132.0/fmt/colors.ts";
export { sprintf } from "https://deno.land/std@0.132.0/fmt/printf.ts";
